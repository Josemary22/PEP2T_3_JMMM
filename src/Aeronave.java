...
public class Aeronave {
    ...
    public static void main(String[] args) {
        ...
        LocalDate FechaAv2 = LocalDate.of(2008, 3, 10);
        ...
        LocalDate FechaJet2 = LocalDate.of(2008, 5, 22);
        ...
        LocalDate FechaAcm2 = LocalDate.of(2008, 10, 28);
        ...
        LocalDate FechaCo2 = LocalDate.of(2022, 9, 14);
